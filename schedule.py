...
# 提出期限を分単位で表示
st.write('タスク表:')
st.table(st.session_state.df[['優先順位', '提出期限', 'タスク']].style.format({'提出期限': '{:%Y-%m-%d %H:%M}'}))
